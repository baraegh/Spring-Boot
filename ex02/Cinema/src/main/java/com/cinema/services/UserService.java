...
import com.cinema.models.User.Confirmation;
...
public class UserService {
    ...
    public void activateAccount(UUID verificationToken) {
        User user = userRepository.findByVerificationToken(verificationToken)
            .orElseThrow(InvalidVerificationTokenException::new);

        user.setConfirmation(Confirmation.CONFIRMED);
        System.err.println("USER: " + user.getUsername() + " token: " + verificationToken);
        userRepository.save(user);
    }
